...
final class Version20210423164248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        if ($this->connection->getDatabasePlatform()->getName() === 'postgresql') {
            $this->addSql('ALTER INDEX ns_node_translation_discr RENAME TO ns_node_discr_translation');
    ...
    public function down(Schema $schema) : void
    {
        if ($this->connection->getDatabasePlatform()->getName() === 'postgresql') {
            ...
            $this->addSql('DROP INDEX cfield_customform_positio');
        ...
        if ($this->connection->getDatabasePlatform()->getName() === 'postgresql') {
            ...
            $this->addSql('ALTER INDEX ns_node_discr_translation RENAME TO ns_node_translation_discr');
