...
class AppController implements ViewableInterface
{
    ...
    public function prepareBaseAssignation()
    {
        ...
        if ($this->kernel->container['securityContext'] !== null &&
            $this->kernel->container['securityContext']->getToken() !== null ) {

            $this->assignation['securityContext'] = $this->kernel
